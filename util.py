...
def save_predictions(test,pred, file,prob,related_file,agree,disagree,discuss):
    ...
    with open(file, 'w') as csvfile:
        fieldnames = ['Headline','Body_ID','Unrelated_Prob']
        writer = DictWriter(csvfile, fieldnames=fieldnames)
        
        writer.writeheader()
        for index, instance in enumerate(pred):
            value = test.instances[index]
            writer.writerow({'Headline': value['Headline'],'Body_ID': value['Body ID'],'Unrelated_Prob':prob[index]})
    with open(related_file, 'w') as csvfile:
        fieldnames = ['Headline','Body_ID','Agree','Disagree','Discuss'] 
        writer = DictWriter(csvfile, fieldnames=fieldnames)
        writer.writeheader() 
        for index, instance in enumerate(pred):
            value = test.instances[index]
            ...
            writer.writerow({'Headline': value['Headline'],'Body_ID': value['Body ID'],'Agree':agree[index],'Disagree':disagree[index],'Discuss':discuss[index]})
